...
print("The value of the first constraint is ",val_res1, " and it should be ",-(N+1)*lambda_1)
...
print("The value of constraint 2 is ",val_res2, " and it should be ",-(N+1)*lambda_2)
...
print("The value of constraint 3 is ",val_res3," and it should be ",-cont*(N+1)**2*lambda_3)
